...
def train(options):
    ...
    if options.restore == 1:
        ...
        if local_rank in [-1, 0]:
            model_path = "/data/wudong/raw_project/planercnn/checkpoint/raw_checkpoint/checkpoint.pth"
    ...
    for epoch in range(options.numEpochs):
        ...
        for sampleIndex, sample in enumerate(data_iterator):
            ...
            for indexOffset in [0, 14]:
                ...
                results =model.predict([images, image_metas, gt_semantic_ids, gt_class_ids, gt_boxes, gt_masks, gt_parameters, camera], mode='training_detection', use_nms=2, use_refinement='refinement' in options.suffix, return_feature_map=True)
