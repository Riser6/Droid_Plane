...
classes_mapping = {41:  0,   #background
                    1:  1,   #wall
                    2:  2,   #floor
                    20: 2,   #floor mat
                    3:  3,   #cabinet
...
class PlaneDatasetSemantic(PlaneDatasetSingle):
    ...
    def __getitem__(self, index):
        ...
        for info in [info_1, info_2]:
            ...
            semantic_ids = np.array(semantic_ids, dtype=np.int32)

            """
            print(image.shape)      (480, 640, 3)
            print(depth.shape)      (480, 640)
            print(mask.shape)       (480, 640, 16)
            print(class_ids.shape)  (16,)
            print(parameters.shape) (16, 4)
            """
            ...
            gt_semantic_ids = semantic_ids
            """
            print(image.shape)          (640, 640, 3)
            print(image_metas.shape)    (16,)
            print(gt_class_ids.shape)   (16,)
            print(gt_boxes.shape)       (16, 4)
            print(gt_masks.shape)       (56, 56, 16)
            print(gt_parameters.shape)  (16, 4)
            """
            ...
            if gt_boxes.shape[0] > self.config.MAX_GT_INSTANCES:
                ...
                gt_semantic_ids = gt_semantic_id[ids]
            ...
            gt_semantic_ids = torch.from_numpy(gt_semantic_ids)
            ...
            data_pair += [image, image_metas, rpn_match, rpn_bbox, gt_semantic_ids, gt_class_ids, gt_boxes, gt_masks, gt_parameters, depth.astype(np.float32), extrinsics.astype(np.float32), planes.astype(np.float32), segmentation, plane_indices]
