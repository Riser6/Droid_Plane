...
class PlaneDatasetSingle(Dataset):
    ...
    def loadClassMap(self):
        ...
        #print(classLabelMap)
        """for name, id in classLabelMap.items():
            if id == 1:
                print(name)"""
        ...
        # add extra labels
        self.confident_labels[19] = True    # mirror
        self.confident_labels[20] = True    # floor mat
        self.confident_labels[24] = True    # refrigerator
        self.confident_labels[25] = True    # TV
        self.confident_labels[32] = True    # night stand

        self.layout_labels[20] = True
        return
